...
TELESCOPE = 'north'
PUBLIC_REPORT_PATH = '/global/cfs/cdirs/desi/users/ziyaoz/dr9m/north'
...
KNL_MEM = 93750000
EXTRA_PARAMS = '--release 9011' # Additional parameter to be passed to runbrick ONLY

# Queue names
PREFIX='ziyao-dr9m-north-'

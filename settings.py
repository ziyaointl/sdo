...
LEGACY_SURVEY_DIR = "/global/cscratch1/sd/ziyaoz/dr9g/north"
SDO_DIR = "/global/cscratch1/sd/ziyaoz/sdo-dr9g-north"
IMAGE_TAG = "dr9.3.4"
SDO_SCRIPT_DIR = os.path.join(SDO_DIR, 'scripts')
QDO_LOGIN_PATH = '/global/cscratch1/sd/ziyaoz/farm/qdo_login.sh'
TELESCOPE = 'north' # north or north
PUBLIC_REPORT_PATH = '/global/project/projectdirs/desi/www/users/ziyaoz/dr9g/north'

...
def main():
    ...
    postfarm = PostFarmStage(POSTFARM_QNAME, sentinel, tasks_per_nodehr=3.5, cores_per_worker=17, job_duration=4, arch='knl', max_nodes_per_job=80)
    postfarm_scavenger_one = PostFarmScavengerStage(POSTFARM_SCAVENGER_ONE_QNAME,
        postfarm, tasks_per_nodehr=1/4, job_duration=4, cores_per_worker=34, arch='knl', max_nodes_per_job=80)
    postfarm_scavenger_two = PostFarmScavengerStage(POSTFARM_SCAVENGER_TWO_QNAME,
        postfarm_scavenger_one, tasks_per_nodehr=1/6, job_duration=6, cores_per_worker=32, arch='haswell', max_nodes_per_job=80)

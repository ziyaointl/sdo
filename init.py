...
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 17, 'srcs', TELESCOPE))
fout.close()
...
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 17, 'writecat', TELESCOPE))
fout.close()
fout = open('scripts/{}.sh'.format(POSTFARM_SCAVENGER_ONE_QNAME), 'w')
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 8, 'writecat', TELESCOPE))
fout.close()
fout = open('scripts/{}.sh'.format(POSTFARM_SCAVENGER_TWO_QNAME), 'w')
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 1, 'writecat', TELESCOPE))
fout.close()

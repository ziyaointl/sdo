...
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 8, 'writecat', TELESCOPE, KNL_MEM // 8))
fout.close()
fout = open('scripts/{}.sh'.format(POSTFARM_SCAVENGER_ONE_QNAME), 'w')
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 2, 'writecat', TELESCOPE, KNL_MEM // 2))
fout.close()

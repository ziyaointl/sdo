...
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 8, 'writecat', TELESCOPE, HASWELL_MEM // 4))
fout.close()
fout = open('scripts/{}.sh'.format(POSTFARM_SCAVENGER_ONE_QNAME), 'w')
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 8, 'writecat', TELESCOPE, HASWELL_MEM // 2))
fout.close()
fout = open('scripts/{}.sh'.format(POSTFARM_SCAVENGER_TWO_QNAME), 'w')
fout.write(runbrick_script.format(LEGACY_SURVEY_DIR, 1, 'writecat', TELESCOPE, HASWELL_MEM))
fout.close()
